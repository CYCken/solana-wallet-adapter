import { BaseMessageSignerWalletAdapter, WalletNotReadyError, WalletReadyState } from '@solana/wallet-adapter-base';
...
export class SecuxWalletAdapter extends BaseMessageSignerWalletAdapter {
    ...
    #readyState: WalletReadyState =
        typeof window === 'undefined' || typeof document === 'undefined' ? WalletReadyState.Unsupported
            : typeof navigator === 'undefined' || !navigator.bluetooth ? WalletReadyState.NotDetected
